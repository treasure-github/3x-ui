...
export const SCHEMAS: Record<string, unknown> = {
  "AllSetting": {
    "description": "AllSetting contains all configuration settings for the x-manager panel including web server, Telegram bot, and subscription settings.",
    "properties": {
      "datepicker": {
  ...
  "Node": {
    "description": "Node represents a remote x-manager panel registered with the central panel.\nThe central panel polls each node's existing /panel/api/server/status\nendpoint over HTTP using the per-node ApiToken to populate the runtime\nstatus fields below.",
    "properties": {
      "activeCount": {
        "example": 23,
        "type": "integer"
  ...
  "Setting": {
    "description": "Setting stores key-value configuration settings for the x-manager panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
  ...
  "User": {
    "description": "User represents a user account in the x-manager panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
